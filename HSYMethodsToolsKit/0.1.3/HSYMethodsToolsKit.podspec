#
# Be sure to run `pod lib lint HSYMethodsToolsKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'HSYMethodsToolsKit'
  s.version          = '0.1.3'
  s.summary          = 'A short description of HSYMethodsToolsKit.'
